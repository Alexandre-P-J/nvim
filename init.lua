  ...
  { -- You can easily change to a different colorscheme.
    ...
    opts = {
      ...
      on_colors = function(colors)
        ...
        colors.bg_float = '#000000' -- background on stuff like telescope
        -- colors.bg_highlight = "#292e42", -- the line the cursor is positioned
        -- colors.bg_popup = "#16161e", -- popup selection of :e suggestions
